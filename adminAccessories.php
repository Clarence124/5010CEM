  ...
  <div class="content">
    ...
    <div class="images">
      <center>
        ...
        // Your database connection code here (e.g., include 'db_studentUsers.php')
        
        // Modify your SQL query to select all titles from the database
        ...
        if ($resultCheck > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Output the image with data attributes
            ...
            // Output the accessory title as a link
            echo '<a href="' . $detailPageURL . '">' . $accessoryTitle . '</a><br>';
          }
        } else {
