<?php
// Fetch product details from your database or data source based on the product ID
// Replace these variables with actual product details
...
<head>
    ...
    <style type="text/css">
        ...
        .product-image {
            ...
            /* Adjust the width as needed */
            flex: 1;
            /* Allow the image to grow and occupy available space */
        }

        .product-image img {
            max-width: 200%;
            /* Set the maximum width as a percentage of its container */
            max-height: 350px;
...
<body>
    ...
    <div class="content">
        ...
        <div class="images">
            ...
            <button id="saveProduct" style="display: none;">Save Product</button>

            <!-- Use input fields and dropdowns to edit product details -->
            <div class="product-container">
                <div class="product-image">
                    <img src="pictures/AD Helmet.jpeg" alt="Product Image" id="productImage">
                </div>

                <div class="product-details">
                    <form id="productForm" method="post">
                        <h1 class="product-title"><AD Uncovered Helmet Motorcycle Helmet Light Four Seasons>
                        </h1>
                        <p class="product-price">
                            Price: RM<span id="productPrice">
                                <?= $productPrice ?>
                            </span>
                        ...
                        <p>
                            ...
                            <select name="productColor">
                                <option value="<?= $productColor ?>" selected>
                                    <?= $productColor ?>
                                </option>
                        ...
                        <!-- Add a hidden input for product ID -->
    ...
    <script>
        ...
        editButton.addEventListener('click', () => {
            // Enable input fields and dropdowns for editing
            ...
            document.querySelector('select[name="productColor"]').removeAttribute('disabled');
