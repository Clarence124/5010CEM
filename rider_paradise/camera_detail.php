...
<head>
    <title>Camera Accessories Page</title>
            ...
            <div class="content-container">
                ...
                <div class="container-box">
                    <div class="products-container">
                        ...
                        ?>
                        <div class="product">
                            <a href="Dash_camera_detail.php?id=C001">
                                <div class="product-image">
                                    <img src="pictures/Motorcycle dash camera.jpeg" alt="Product Image">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">Motorcycle Dash Cam Front Rear Camera DVR System with 2
                                        inch Display </h3>
                                    <p class="product-price">Price: RM85</p>
                        ...
                        <div class="product">
                            <a href="Veltics_jelmet_detail.php?id=2">
                                <div class="product-image">
                                    <img src="pictures/Sport camera.jpeg" alt="Sport camera">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">4K Ultra HD action camera 30M Waterproof Sport WiFi Action
                                        Camera</h3>
                        ...
                        <div class="product">
                            <a href="GOJO_jacket_detail.php?id=3">
                                <div class="product-image">
                                    <img src="pictures/Livetech camera.jpeg" alt="Livetech Camera">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">LiveTech Wireless Waterproof Motorcycle Camera Camcorder
                                    </h3>
                                    <p class="product-price">Price: RM110.00- RM150.00</p>
                                    <div class="product-rating">
                                        <i class="bx bx-star"></i>
                                        <i class="bx bx-star"></i>
                                        <i class="bx bx-star"></i>
                        ...
                        <div class="product">
                            <a href="GT_helmet_detail.php?id=4">
                                <div class="product-image">
                                    <img src="pictures/Motowolf dash cam.jpeg" alt="Motowolf">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">MOTOWOLF Motorcycle Dash Cam Holder Camera GoPro Mount
                                    </h3>
                        ...
                        <div class="products-container1">
                            ...
                            <div class="product1">
                                <a href="air_jordan_jacket.php?id=5">
                                    <div class="product-image">
                                        <img src="pictures/Sjcam camera.jpeg" alt="Sjcam camera">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">SJ4000 AIR 4K VIDEO SUPER HIGH QUALITY ACTION CAMERA
                                        </h3>
                            ...
                            <div class="product1">
                                <a href="PU_leather_jacket_detail.php?id=6">
                                    <div class="product-image">
                                        <img src="pictures/Ekleva camera.jpeg" alt="Ekleva camera">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">Ekleva Full Body Waterproof Motorcycle Camera</h3>
                            ...
                            <div class="product1">
                                <a href="Honda_jacket_detail.php?id=7">
                                    <div class="product-image">
                                        <img src="pictures/ATTSSB camera.jpeg" alt="ATTSB camera">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">ATSSB Wireless Waterproof Motorcycle Camera Camcorder
                                            Full HD</h3>
                                        <p class="product-price">Price: RM160.00</p>
                                        <div class="product-rating">
                                            <i class="bx bx-star"></i>
                                            <i class="bx bx-star"></i>
                                            <i class="bx bx-star"></i>
                            ...
                            <div class="product1">
                                <a href="North_face_jacket_detail.php?id=8">
                                    <div class="product-image">
                                        <img src="pictures/FHD camera.jpeg" alt="FHD waterproof camera">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">FHD Waterproof Camera Motorcycle DVR
                                            Front Rear Dual Camera</Ah3>
                                            <p class="product-price">Price: RM60.00</p>
                                            <div class="product-rating">
                                                <i class="bx bx-star"></i>
                                                <i class="bx bx-star"></i>
                                                <i class="bx bx-star"></i>
