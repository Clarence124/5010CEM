        ...
        <div class="content-container">
            ...
            <div class=container-box>
                <div class="products-container">
                    ...
                    <div class="product">
                        <a href="AD_helmet_detail.php?id=H001">
                            ...
                            <div class="product-details">
                                ...
                                <p class="product-price">Price: RM100.00-RM130.00</p>
                    ...
                    <div class="product">
                        <a href="GDM_Demon_Helmet_detail.php?id=H002">
                            ...
                            <div class="product-details">
                                ...
                                <p class="product-price">Price: RM100.99-RM200.00</p>
                                <div class="product-rating">
                                    <i class="bx bx-star"></i>
                                    <i class="bx bx-star"></i>
                                    <i class="bx bx-star"></i>
                    ...
                    <div class="product">
                        <a href="BYE_helmet_detail.php?id=3">
                            <div class="product-image">
                                <img src="pictures/BYE Helmet.jpeg" alt="BYE Half-facce Helmet">
                            </div>
                            <div class="product-details">
                                <h3 class="product-title">BYE Motorcycle Open Half Face Helmet chopper Scooter Helmet
                                    Double
                                    Lenses</h3>
                    ...
                    <div class="product">
                        <a href="GT_helmet_detail.php?id=4">
                            <div class="product-image">
                                <img src="pictures/GT Helmet.jpeg" alt="GTmotor Helmet">
                            </div>
                            <div class="product-details">
                                <h3 class="product-title">GTmotor GXT708 Double Lens Motorcycle Helmet Half Helmet</h3>
                                <p class="product-price">Price: RM169.00</p>
                                <div class="product-rating">
                                    <i class="bx bx-star"></i>
                                    <i class="bx bx-star"></i>
                                    <i class="bx bx-star"></i>
            ...
            <div class=container-box>
                <div class="products-container1">
                    ...
                    ?>
                    <div class="product1">
                        <a href="Yamaha_helmet_detail.php?id=5">
                            <div class="product-image">
                    ...
                    <div class="product1">
                        <a href="Black_samurai_helmet_detail.php?id=6">
                            <div class="product-image">
                    ...
                    <div class="product1">
                        <a href="Gracshaw_helmet_detail.php?id=7">
                            <div class="product-image">
                                <img src="pictures/Gracshaw helmet.jpeg" alt="Gracshaw Helmet">
                            </div>
                            <div class="product-details">
                                <h3 class="product-title">Helmet Gracshaw Geomex G555 Itay Open Face Helme</h3>
                                <p class="product-price">Price: RM109.00</p>
                                <div class="product-rating">
                                    <i class="bx bx-star"></i>
                                    <i class="bx bx-star"></i>
                                    <i class="bx bx-star"></i>
                    ...
                    <div class="product1">
                        <a href="Double_visor_helmet_detail.php?id=8">
                            <div class="product-image">
