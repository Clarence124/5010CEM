...
<head>
    <title>Jacket Accessories Page</title>
            ...
            <div class="content-container">
                ...
                <div class="container-box">
                    <div class="products-container">
                        ...
                        ?>
                        <div class="product">
                            <a href="NIKE_jacket_detail.php?id=J001">
                                <div class="product-image">
                                    <img src="pictures/Nike Jacket.jpg" alt="Product Image">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">NIKE Jacket Waterproof Jaket Kalis Air Windbreaker Jaket
                                        Motor Unisex</h3>
                                    <p class="product-price">Price: RM85.00-RM100.00</p>
                        ...
                        <div class="product">
                            <a href="Veltics_jelmet_detail.php?id=J002">
                                <div class="product-image">
                                    <img src="pictures/Veltics jacket.jpeg" alt="Bomber Veltics Jacket">
                                </div>
                                <div class="product-details">
                        ...
                        <div class="product">
                            <a href="GOJO_jacket_detail.php?id=3">
                                <div class="product-image">
                                    <img src="pictures/GOJO Unisex jacket.jpeg" alt="GOJO Unisex jacket">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">GOJO Unisex Jacket Waterproof Waterproof Outdoor Men</h3>
                                    <p class="product-price">Price: RM101.00</p>
                                    <div class="product-rating">
                                        <i class="bx bx-star"></i>
                                        <i class="bx bx-star"></i>
                                        <i class="bx bx-star"></i>
                        ...
                        <div class="product">
                            <a href="GT_helmet_detail.php?id=4">
                                <div class="product-image">
                                    <img src="pictures/Air jacket.jpeg" alt="GTmotor Helmet">
                                </div>
                                <div class="product-details">
                                    <h3 class="product-title">S-5XL Jacket Reflective Windbreaker Unisex Baju Kalis Air
                                        Jacket</h3>
                                    <p class="product-price">Price: RM75.00</p>
                                    <div class="product-rating">
                                        <i class="bx bx-star"></i>
                                        <i class="bx bx-star"></i>
                                        <i class="bx bx-star"></i>
                        ...
                        <div class="products-container1">
                            ...
                            <div class="product1">
                                <a href="air_jordan_jacket.php?id=5">
                                    <div class="product-image">
                                        <img src="pictures/Air jordan jacket.png" alt="Air jordan jacket">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">AIR JORDAN WINGS DIAMOND JACKET ATMOSPHERE GREY</h3>
                            ...
                            <div class="product1">
                                <a href="PU_leather_jacket_detail.php?id=6">
                                    <div class="product-image">
                                        <img src="pictures/PU leather jacket.jpeg" alt="Leather jacket">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">Motorcycle Jacket PU Leather Jacket Men's Collar
                                            Leather
                                            Jacket</h3>
                            ...
                            <div class="product1">
                                <a href="Honda_jacket_detail.php?id=7">
                                    <div class="product-image">
                                        <img src="pictures/Honda jacket.jpeg" alt="GTmotor Helmet">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">HONDA MOTO Leather Jacket Large Size Men Warm Printed
                                            Car
                                            Motorcycle Riding</h3>
                                        <p class="product-price">Price: RM120.00</p>
                                        <div class="product-rating">
                                            <i class="bx bx-star"></i>
                                            <i class="bx bx-star"></i>
                                            <i class="bx bx-star"></i>
                            ...
                            <div class="product1">
                                <a href="North_face_jacket_detail.php?id=8">
                                    <div class="product-image">
                                        <img src="pictures/North face jacket.jpeg" alt="North face jacket">
                                    </div>
                                    <div class="product-details">
                                        <h3 class="product-title">North Face Jacket Unisex Outdoor Waterproof Motorcycle
                                            Hoodie Jacket</h3>
                                        <p class="product-price">Price: RM60.00- RM70.00</p>
                                        <div class="product-rating">
                                            <i class="bx bx-star"></i>
                                            <i class="bx bx-star"></i>
                                            <i class="bx bx-star"></i>
                    ...
                    <s<script>
                        ...
                        var priceFilter = !isNaN(productPrice) && productPrice >= minPrice && productPrice <= maxPrice;
                            var ratingFilter=selectedRatings.length===0 || selectedRatings.includes(productRating); if
                            (brandFilter && priceFilter && ratingFilter) { $(this).show(); } else { $(this).hide(); }
                            }); } </script>
