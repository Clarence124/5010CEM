  ...
  <div class="sidebar open">
    <ul>
      <center>
        ...
        <li><a href="checkout_page.php"><i class='bx bxs-cart-download'></i><span class="tooltip">Checkout</span>
  ...
  <div class="content">
    ...
    <div class="profdetails">
      ...
      <div class="topnav">
        ...
        <button class="tab-button" onclick="openTab('ProfileTab')"><i class="fa-regular fa-address-card fa-beat"></i>
          Profile</button>
        <button class="tab-button" onclick="openTab('OrderHistoryTab')"><i
            class="fa-solid fa-cart-shopping fa-beat"></i> Order History</button>
        <button class="tab-button" onclick="openTab('PaymentDetailsTab')"> <i class="fas fa-money-check fa-beat"></i>
      ...
      <div id="ProfileTab" class="tab">
        <form method="post" action="#">
          <table>
            ...
            <<tr class="form-group">
              <td>
                <input type="text" class="form-control" name="fullname" style="width:300px;"
                  placeholder="Enter your Fullname" value="<?= isset($row['fullname']) ? $row['fullname'] : '' ?>"
                  required />
              </td>
              <td>
                <input type="text" class="form-control" name="uname" style="width:300px;"
                  placeholder="Enter your Username" value="<?= isset($row['username']) ? $row['username'] : '' ?>"
                  required />
              </td>
              <td>
                <input type="text" class="form-control" name="email" style="width:300px;" placeholder="Enter your Email"
                  value="<?= isset($row['email']) ? $row['email'] : '' ?>" required />
              </td>
              </tr>
              <tr class="form-group">
              ...
              <tr class="form-group">
                ...
                <td><input type="text" class="form-control" name="pnumber" style="width:300px;"
                    placeholder="Enter your Phone Number" value="<?php echo $row['pnumber']; ?>" required /></td>
                <td><input type="password" class="form-control" name="pass" style="width:300px;"
                    placeholder="Enter New Password" value="<?php echo $row['pass']; ?>" required /></td>
                <td><input type="password" class="form-control" name="cpass" style="width:300px;"
                    placeholder="Confirm Password" value="<?php echo $row['cpass']; ?>" required /></td>
              ...
              <tr class="form-group">
                ...
                <td><input type="text" class="form-control" name="address" style="width:300px;" required
                    placeholder="Enter your Address" value="<?php echo $row['address']; ?>" /></td>
              </tr>
        ...
        <div class="payment-details-container">
          ...
          <form id="payment-form" action="userPaymentCheck.php" method="post">
                ...
                <div class="form-column">
                  <div class="Paymentdetails">
                    <div class="form-group">
                      ...
                      <input type="text" id="cardnum" class="cardnum" name="cardnum" placeholder="Enter your card number"
                        pattern="\d{16}" title="Card number must be 16 digits"
                        value="<?php echo $paymentRow['cardnum']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="card-holder">Cardholder Name:</label>
                      <input type="text" id="cardname" class="cardname" name="cardname"
                        placeholder="Enter cardholder name" value="<?php echo $paymentRow['cardname']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="expiration">Expiration Date (MM/YY):</label>
                      <select id="expmonth" class="expmonth" name="expmonth">
                        <option value="<?php echo $paymentRow['expmonth']; ?>" selected>
                          <?php echo $paymentRow['expmonth']; ?>
                        </option>
                        <!-- Other options here -->
                      ...
                      <select id="expyear" class="expyear" name="expyear">
                        <option value="<?php echo $paymentRow['expyear']; ?>" selected>
                          <?php echo $paymentRow['expyear']; ?>
                        </option>
                        <!-- Other options here -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="cvvcode" class="cvvcode" name="cvvcode" placeholder="Enter CVV"
                        pattern="\d{3}" title="CVV must be 3 digits" value="<?php echo $paymentRow['cvvcode']; ?>">
                    </div>
                  </div>
                </div>
                <div class="form-column">
            ...
            <?php
              ...
              ?>
            <button type="button" onclick="window.location.href = 'newPaymentDetails.php';">Insert Payment
              Details</button>
            <?php
            }
            ?>
