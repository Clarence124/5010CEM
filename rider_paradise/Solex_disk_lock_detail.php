...
<head>
    <title>Security lock Detail</title>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="product-container">
                    <div class="product-image">
                        <img id="mainImage" src="pictures/Solex Disk lock.jpeg" alt="Solex Disk Lock">
                    ...
                    <div class="product-details">
                        ...
                        <div class="button-container">
                            <button type="button" class="add-to-cart-button"
                                onclick="addToCart('J001','Nike jacket', 'pictures/Nike jacket.jpg', 'RM85.00', 'Black', 'S', '1')">Add
                                to
                                Cart</button>
