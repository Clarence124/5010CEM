...
<head>
  ...
  <style type="text/css">
    ...
    .content .container .title {
      ...
      /* Make the title inline so the underline is centered below it */
      margin-bottom: 50px;
    }
    ...
    #salesPieChart {
      margin-top: 20px;
      /* Adjust the margin as needed to position the chart below other content */
      background-color: #fff;
      /* Set a background color to make the chart stand out */
      padding: 20px;
      /* Add padding to the chart for spacing */
    }
...
<body>
  ...
  <div class="marquee">
    ...
    <marquee scrollamount="16">
      <h1>Stay Safe on the Road - Check Your Brakes Regularly!</h1>
    </marquee>
  ...
  <div class="content">
    ...
    <div class="aboutus">
      ...
      <h1> Welcome to Riders Paradise - Your Ultimate Destination for Quality Motorcycle Spare Parts and Accessories!
      </h1>

      <div class="aboutusdetails">


        <p>Our passion for riding drives us to provide top-notch products, meticulously selected and tested to meet your
          standards.</p>

        <p>We're more than just an online store; we're a vibrant community dedicated to enhancing your riding experience
          and keeping your motorcycle in peak condition.</p>
      ...
      <div class="faq">
        <div class="faq-item">
          <div class="faq-question" onclick="toggleAnswer('answer1')">
            <div class="question-text">1. What types of motor spare parts do you offer?</div><i class="fas fa-plus"></i>
          </div>
          <div class="faq-answer" id="answer1">We offer a wide range of motor spare parts, including but not limited to
            engine components, brakes, suspension parts, electrical components, and more. Browse our catalog for a
            complete list.</div>
        </div>

        <div class="faq-item">
          <div class="faq-question" onclick="toggleAnswer('answer2')">
            <div class="question-text">2. Are your spare parts compatible with my vehicle?</div><i
              class="fas fa-plus"></i>
          </div>
          <div class="faq-answer" id="answer2">Our spare parts are compatible with a variety of makes and models. To
            ensure compatibility, please use our vehicle lookup tool on the product pages or contact our customer
            support team for assistance.</div>
        </div>

        <div class="faq-item">
          <div class="faq-question" onclick="toggleAnswer('answer3')">
            <div class="question-text">3. How can I find the specific part I need?</div><i class="fas fa-plus"></i>
          </div>
          <div class="faq-answer" id="answer3">You can use our search bar to enter keywords, part numbers, or browse
            through our categories. Additionally, you can filter products by make, model, and year for a more targeted
            search.</div>
        </div>

        <div class="faq-item">
          <div class="faq-question" onclick="toggleAnswer('answer4')">
            <div class="question-text">4. How can I contact your customer support team?</div><i class="fas fa-plus"></i>
          </div>
          <div class="faq-answer" id="answer4">You can reach our customer support team by contacting us. We're available
            via email, phone, and live chat during our business hours.</div>
        </div>

        <div class="faq-item">
          <div class="faq-question" onclick="toggleAnswer('answer5')">
            <div class="question-text">5. How do I know if a part is in stock?</div><i class="fas fa-plus"></i>
          </div>
          <div class="faq-answer" id="answer5">On each product page, you'll find real-time stock availability
            information. If a product is out of stock, you can sign up for notifications to be alerted when it becomes
            available again.</div>
        </div>
