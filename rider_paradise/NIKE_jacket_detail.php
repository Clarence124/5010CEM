...
<body>
    ...
    <script>
        ...
        function addToCart() {
            ...
            const productImage = "rider_paradise/pictures/Nike Jacket.jpg";
            ...
            // Construct the URL with the product details
            const url = `shopping_cart.php?product_id=${productId}&productImage=${productImage}&productName=${productName}&price=${price}&color=${color}&size=${size}`;
